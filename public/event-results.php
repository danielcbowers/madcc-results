...
foreach ($results as &$result) {
    ...
    if ($result->status === 'Finished') {
        ...
        $finish = strtotime('1970-01-01 ' . $result->finish_time);

        // Bib numbers represent start minutes
        $result->actual_seconds = $finish - ((int)$result->bib_number * 60);

        $result->actual_time = gmdate('H:i:s', $result->actual_seconds);
...
<div class="mcc-results">
    ...
    <?php if (empty($results)) : ?>
        ...
        <p>No results have been entered yet for this event.</p>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo esc_html($result->actual_time); ?>
